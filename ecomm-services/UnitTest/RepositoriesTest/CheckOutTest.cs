   ...
   public class CheckOutTest : InitializeContext
    {
        ...
        public CheckOutTest()
        {
            ...
            _orderRepository = new OrderRepository(context ,_basketRepository);
        ...
        public void TestCheckout_NeededMoreThanInStock()
        {
          ...
          //  Assert.Throws<OrderException>(() => _orderRepository.CheckOut( UserId, OrderBillingAddress, OrderShippingAddress, Slot));
        ...
        public void TestCheckout_SlotIsFull()
        {
          ...
          //  Assert.Throws<DeliveryException>(() => _orderRepository.CheckOut( UserId, OrderBillingAddress, OrderShippingAddress, Slot));
        }
        ...
        public void TestCheckout_OK()
        {
          ...
          //  _orderRepository.CheckOut( UserId, OrderBillingAddress, OrderShippingAddress, Slot);
